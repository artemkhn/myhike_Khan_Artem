...
function writeHikes() {
    ...
    hikesRef.add({
        code: "BBY01",
        name: "Cypress Provincial Park", //replace with your own city?
        city: "Vancouver",
        province: "BC",
        level: "Moderate",
        length: "11 km",
        details: "Artem goes here regularly"
    });
    hikesRef.add({
        code: "AM01",
        name: "Horseshoe Bay - Deep Cove", //replace with your own city?
        city: "Vancouver",
        province: "BC",
        level: "Extreme",
        length: "48 km",
    ...
    hikesRef.add({
        code: "NV01",
        name: "Lynn Headwaters Regional Park", //replace with your own city?
        city: "Vancouver",
        province: "BC",
        level: "Moderate",
        length: "14 km",
